...
function onPlayerJoined(playerId)
	...
	if licence and steamhex then
		if ESX.GetPlayerFromIdentifier(steamhex) then
...
RegisterNetEvent('esx:gimecagoentuputamdredumperdemierdaveInventoryItem')
AddEventHandler('esx:gimecagoentuputamdredumperdemierdaveInventoryItem', function(target, type, itemName, itemCount)
	local playerId = source
