...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $(".identity-page-blocks").html('<div class="identity-page-block" data-type="id_card" onmouseover="'+hoverDescription("id_card")+'" onmouseout="'+hoverDescription("id_card")+'"><p>DNI</p></div>');
...
hoverDescription = function(type) {
    if (!mouseOver) {
        if (type == "id_card") {
            ...
            $(".hover-description").html('<p>Necesitas una Identificación para que puedas ser identificado</p>');
        }
    } else {
...
$(document).on("click", ".identity-page-block", function(e){
    ...
    if (selectedIdentity == null) {
        ...
        if (idType== "id_card") {
            ...
            $(".request-identity-button").html("<p>id_card aanvragen (€50,-)</p>")
        } else {
            $(".request-identity-button").fadeIn(100);
