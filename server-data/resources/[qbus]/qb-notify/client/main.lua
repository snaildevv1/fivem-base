RegisterNetEvent('qb-notify:client:SendAlert')
AddEventHandler('qb-notify:client:SendAlert', function(data)
	DoCustomHudText(data.type, data.text, data.length, data.style)
end)

RegisterNetEvent('qb-notify:client:PersistentHudText')
AddEventHandler('qb-notify:client:PersistentHudText', function(data)
